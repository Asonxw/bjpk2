package com.as.boot.mdpk10.thread;

import java.text.DecimalFormat;
import java.text.SimpleDateFormat;

import com.alibaba.fastjson.JSONObject;
import com.as.boot.mdpk10.controller.ExampleControll;
	...
	public void run() {
		while (true) {
			...
			try {
				...
				HotClFrame_mdpk.logTableDefaultmodel.insertRow(0, new String[]{"！！！！！！！！！！"+ExampleControll.nextFFCRound+"期，获取开奖失败！！！"});
				urlIndex++;
				if(urlIndex>2)urlIndex=0;
			}
		}
